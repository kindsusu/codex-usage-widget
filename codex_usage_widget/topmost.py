...
class SmartTopmostController:
    ...
    def _set_zorder(self, keep_top: bool) -> None:
        _ = self._set_topmost(keep_top)
        _ = set_window_zorder(self._root.winfo_id(), "top" if keep_top else "normal")
